...
#pacman -S --noconfirm grub os-prober efibootmgr networkmanager network-manager-applet dialog wpa_supplicant wireless_tools dosfstools mtools linux-headers openssh reflector sof-firmware dnsmasq pulseaudio alsa-utils virt-manager qemu qemu-arch-extra acpi acpi_call cups ntfs-3g tlp

# Soft package

pacman -S --noconfirm grub os-prober efibootmgr networkmanager network-manager-applet dialog wpa_supplicant wireless_tools openssh reflector tlp
